...
public class SnakeAnnotation {
	...
	private static final Logger log = LoggerFactory.getLogger(SnakeAnnotation.class);
	...
	public void onOpen(Session session) {
		log.info(session.getId() + "-" + session.getQueryString() + "-" + session.getMaxBinaryMessageBufferSize());

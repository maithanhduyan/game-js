...
/**
 * A message that represents a drawing action. Note that we use primitive types
 * instead of Point, Color etc. to reduce object allocation.<br>
 * <br>
 *
 * TODO: But a Color objects needs to be created anyway for drawing this onto a
 * Graphics2D object, so this probably does not save much.
 */
public final class DrawMessage {
	 ...
	 * WebSocket.<br>
	 * Since a DrawMessage consists only of numbers, we concatenate those numbers
	 * with a ",".
	 */
	@Override

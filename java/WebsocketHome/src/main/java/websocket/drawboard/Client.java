...
public class Client {
	...
	/**
	 * Contains the messages which are buffered until the previous send operation
	 * has finished.
	 */
	...
	/**
	 * If this client is closing. If <code>true</code>, new messages to send will be
	 * ignored.
	 */
	private volatile boolean isClosing = false;
	/**
	 * The length of all current buffered messages, to avoid iterating over a linked
	 * list.
	 */
	 ...
	 * remaining messages have been sent to the Client and then close the Websocket
	 * session.
	 */
	public void close() {
	...
	/**
	 * Sends the given message asynchronously to the client. If there is already a
	 * async sending in progress, then the message will be buffered and sent when
	 * possible.<br>
	 * <br>
	 *
